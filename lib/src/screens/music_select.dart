...
class _MusicListPageState extends State<MusicListPage> {
  ...
  final CollectionReference playlistsCollection = FirebaseFirestore.instance
      .collection('playlists'); // Coleção de playlists
  ...
  Widget _buildAddToPlaylistButton(DocumentSnapshot musicSnapshot) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        primary: Color.fromARGB(255, 43, 177, 240), // Cor de fundo azul-ciano
...
class AddToPlaylistPage extends StatelessWidget {
  ...
  void _addToPlaylist(BuildContext context, String playlistId) async {
    try {
      ...
      // Obter o array existente de musicIds
      ...
      // Adicionar o novo ID de música ao array
      musicIds.add(musicId);

      // Atualizar o documento da playlist com o novo array de musicIds
